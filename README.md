...
*Pirá* is a manually-constructed dataset of questions and answers about the ocean and the Brazilian coast designed for reading comprehension. You can download the full paper [here]().

The dataset contains 2261 QA sets, as well as the texts associated with them. Each QA set contais at least four elements: a question in Portuguese and in English, and an answer in Portuguese and in English. Around 90% of the QA sets also contain manual evaluations.
...
The United Nations' Reports on the ocean are freely accesible in the links above.
